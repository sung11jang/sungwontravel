...
const defaultChecklists = [
  ...
  { id: 'c6', text: '넷플릭스/유튜브/쿠팡플레이 오프라인 영상 다운로드', category: 'OTT/엔터', checked: false },
  { id: 'c7', text: '오프라인 음악 플레이리스트 다운로드', category: 'OTT/엔터', checked: false },
  { id: 'c8', text: '유선 이어폰 및 젠더 (기내 영화 & 배터리 방전 대비)', category: 'OTT/엔터', checked: false },
  { id: 'c9', text: '보조배터리 (기내 수하물 휴대 필수)', category: '전자기기', checked: false },
  { id: 'c10', text: 'eSIM 등록 QR / 유심 핀', category: '전자기기', checked: false },
  { id: 'c11', text: '멀티 어댑터 (돼지코) & 초고속 멀티 충전기', category: '전자기기', checked: false },
  { id: 'c12', text: '스마트폰 방수팩 (물 속 터치 확인)', category: '물놀이/휴양', checked: false },
  { id: 'c13', text: '아쿠아슈즈 & 래시가드/수영복', category: '물놀이/휴양', checked: false },
  { id: 'c14', text: '샤워기 필터 & 비타민 리필 (수질 민감 대비)', category: '물놀이/휴양', checked: false },
  { id: 'c15', text: '알로에 수딩젤 (햇빛 화상 진정용)', category: '물놀이/휴양', checked: false },
  { id: 'c16', text: '상비약 (지사제, 소화제, 타이레놀, 감기약, 모기약)', category: '상비약', checked: false },
  { id: 'c17', text: '휴대용 손선풍기 & 쿨링 패치', category: '편의용품', checked: false },
...
const initialSchedules = [
  ...
  { id: 's7', day: 'day4', time: '15:00', title: '라페스타 푸꾸옥 힐튼 체크인', type: 'HOTEL', location: 'La Festa Phu Quoc, Curio Collection by Hilton', memo: '선셋타운 야경 감상' },
  { id: 's8', day: 'day5', time: '19:30', title: '인천공항 T1 도착 및 장기주차장 출차', type: 'CAR', location: '인천국제공항 제1여객터미널 장기주차장', memo: '무인 정산기 사전 결제' },
];
...
const initialDocs = [
  ...
  },
  {
    id: 'd2',
    category: '항공권',
    title: '비엣젯 항공 VJ977 모바일 탑승권',
    code: 'VJ977 / 12월 12일 10:30 출발',
    memo: '인천 T1 탑승동 114번 게이트 (수하물 20kg 포함)',
    imgUrl: '',
    rawEmail: ''
  }
];
        ...
        {activeTab === 'docs' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ backgroundColor: '#FFFFFF', padding: '16px', borderRadius: '16px', border: '1px solid #E2E8F0' }}>
              ...
              <textarea
                rows={2}
                placeholder="호텔 회신 이메일 본문 (셔틀 시간, 미팅 장소 등)"
                value={emailText}
